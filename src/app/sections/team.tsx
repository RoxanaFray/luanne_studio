  ...
  return (
    <main className="w-full">
      ...
      <div className="font-MPlusLight flex flex-col items-start px-8 sm:px-48">
        ...
        <h5 className="text-xl sm:text-3xl mb-16 sm:mb-20 mt-12 sm:mt-16 max-w-full sm:max-w-4xl text-start text-black/70 leading-normal tracking-wide antialiased">
          {t("team_description")}
        </h5>
