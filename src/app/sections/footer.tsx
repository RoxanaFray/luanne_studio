...
export default function Footer() {
    ...
    return (
        <main id="contacts">
            ...
            <div className="flex flex-col xl:flex-row items-center xl:items-stretch justify-start xl:justify-between px-8 xl:px-28 xl:container xl:mx-auto h-fit xl:h-auto mt-8 xl:mt-0 mb-20 md:mb-12 xl:mb-20 gap-12 xl:gap-8">
